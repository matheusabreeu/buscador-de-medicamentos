    ...
    <body class="bg-slate-950 text-slate-100 p-4 font-sans selection:bg-cyan-500/30">
        <div class="max-w-md mx-auto">
            <header class="text-center py-12">
                ...
                <p class="text-emerald-500 text-sm font-bold uppercase">Os melhores preços para a Família Abreu</p>
            </header>

            <form method="POST" action="/" class="bg-slate-900 p-10 rounded-[40px] border border-white/10 shadow-2xl mb-16">
                <input type="text" name="remedio" value="${q}" placeholder="Digite o que você quer buscar" required
